...
with open("K_COVID19.csv", 'r') as file:
    ...
    # Use column 24(region_code), 4(province), 5(city), 25(latitude), 26(longitude), 27(elementary_school_count), 28(kindergarten_count), 29(university_count), 30(academy_ratio)
    #           31(elderly_population_ratio),31(elderly_alone_ratio), 32(nursing_home_count)
    # index = column - 1
    col_list = {
        'region_code' :23,
        'province' :3,
